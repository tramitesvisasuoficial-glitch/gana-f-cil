      ...
      <div className="container mx-auto flex h-[60px] items-center justify-between px-2 w-full">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <Link href="/" className="flex items-center gap-0.5 shrink-0 mr-2">
            ...
            <span className="text-[10px] font-bold tracking-tight text-black mt-0.5 shrink-0">
              Avanza Financial
            </span>
          </Link>
          ...
          <div className="flex items-center gap-3 shrink-0">
            <div className="group relative cursor-pointer py-4">
              <span className="text-[7px] font-bold text-black flex items-center gap-0.5 whitespace-nowrap">
                Préstamos
              ...
              <div className="absolute top-full left-0 hidden group-hover:flex flex-col bg-white border border-gray-200 shadow-lg rounded-md w-36 z-50 overflow-hidden">
                <Link href="/apply" className="px-4 py-2.5 text-[8px] font-bold text-black hover:bg-gray-50 transition-colors">Préstamos Personales</Link>
                <Link href="/apply" className="px-4 py-2.5 text-[8px] font-bold text-black hover:bg-gray-50 transition-colors border-t border-gray-100">Préstamos con Garantía</Link>
              </div>
            </div>
            ...
            <div className="group relative cursor-pointer py-4">
              ...
              <div className="absolute top-full left-0 hidden group-hover:flex flex-col bg-white border border-gray-200 shadow-lg rounded-md w-40 z-50 overflow-hidden">
                <Link href="/savings" className="px-4 py-2.5 text-[8px] font-bold text-black hover:bg-gray-50 transition-colors">Conocer Plan Set & Save</Link>
                <Link href="/apply-savings" className="px-4 py-2.5 text-[8px] font-bold text-black hover:bg-gray-50 transition-colors border-t border-gray-100">Abrir cuenta de ahorros</Link>
              </div>
            </div>
            
            <Link href="/locations" className="text-[7px] font-bold text-black py-4 whitespace-nowrap hover:underline">
              Sucursales
            </Link>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 shrink-0 pl-2">
          <Link href="/login" className="text-[7px] font-bold text-black flex items-center gap-0.5 hover:underline whitespace-nowrap">
            Iniciar sesión
          ...
          <Button asChild className="bg-black text-white hover:bg-black/90 font-bold px-3 py-1 rounded-[10px] text-[7px] h-6 whitespace-nowrap ml-2">
