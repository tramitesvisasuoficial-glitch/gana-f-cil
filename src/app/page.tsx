              ...
              <div className="flex flex-col items-center md:items-start gap-4">
                ...
                <div className="flex flex-col gap-3 w-full md:w-auto">
                  ...
                  <Link
                    ...
                    className="flex items-center justify-center md:justify-start gap-2 text-sm font-medium text-black hover:text-gray-600 transition-colors"
                  >
                    ...
                    Prefiero hablar con una asesora por WhatsApp
                  </Link>
                </div>
